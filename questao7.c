...
void main(){
	...
	int opiniao, gostou=0, naoGostou=0, genero, masculino, feminino, i; // opiniao do cliente e genero
	
	for(i=0;i<3;i++)
	{
		printf("Se voce gostou do novo produto digite o numero de acordo com sua opiniao: \n\n");
	    printf("1- Gostou // 2- Nao gostou. \n");
	    scanf("%d", &opiniao);
	...
	{
		printf("A maior taxa de aprovacao foi do genero masculino\n");
	}
	else
	{
		printf("A maior taxa de aprovacao foi do genero feminino\n");
	}
